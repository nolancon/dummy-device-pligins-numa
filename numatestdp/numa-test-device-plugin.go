...
func (test *testManager) discoverTestResources() error {
	...
	dev001 := pluginapi.Device{ID: "25102017", Health: pluginapi.Healthy, Topology: &pluginapi.TopologyInfo{Nodes: []*pluginapi.NUMANode{{ID: 0}}}}
	dev002 := pluginapi.Device{ID: "26102017", Health: pluginapi.Healthy, Topology: &pluginapi.TopologyInfo{Nodes: []*pluginapi.NUMANode{{ID: 1}}}}
	dev003 := pluginapi.Device{ID: "27102017", Health: pluginapi.Healthy, Topology: &pluginapi.TopologyInfo{Nodes: []*pluginapi.NUMANode{{ID: 1}}}}
