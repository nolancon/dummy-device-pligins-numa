...
func (test *testManager) discoverTestResources() error {
	...
	dev001 := pluginapi.Device{ID: "35102017", Health: pluginapi.Healthy, Topology: &pluginapi.TopologyInfo{Nodes: []*pluginapi.NUMANode{{ID: 0}}}}
	dev002 := pluginapi.Device{ID: "36102017", Health: pluginapi.Healthy, Topology: &pluginapi.TopologyInfo{Nodes: []*pluginapi.NUMANode{{ID: 0}}}}
	dev003 := pluginapi.Device{ID: "37102017", Health: pluginapi.Healthy, Topology: &pluginapi.TopologyInfo{Nodes: []*pluginapi.NUMANode{{ID: 1}}}}
